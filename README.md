...
* [为什么强制 element.class#id 而不允许 element#id.class 的写法？](idcls_order)
...
* [为什么 subtemplate 使用 element.class = model 的语法，而不用类似 Jade 的 简单 mixin f(params) 形式？](mixin_cons)
